...
def parsing_args(c):
    ...
    if c.dataset == 'mvtec':
        ...
        setattr(c, 'data_path', 'E:/0-Project/AnomolyDetection/2-dataset/MVTec')
        ...
        setattr(c, 'data_path', 'E:/0-Project/AnomolyDetection/2-dataset/MIAD')
        if c.class_names == ['all']:
            setattr(c, 'class_names', MIAD_CLASS_NAMES)
        
    # c.input_size = (256, 256) if c.class_name == 'transistor' else (512, 512)
    c.input_size = (128, 128) if c.class_name == 'transistor' else (512, 512)
